...
// @updateURL     https://github.com/LianSheng197/RTools/raw/side-prj/IITC%20Plugin%20-%20Player%20Inventory%20(Kaizo%20Version).user.js
// @downloadURL   https://github.com/LianSheng197/RTools/raw/side-prj/IITC%20Plugin%20-%20Player%20Inventory%20(Kaizo%20Version).user.js
    ...
    */
    ...
    function setupCSS() {
        ...
        if (playerInventory.settings.lvlColorEnable) {
            window.COLORS_LVL.forEach((c, i) => {
                ...
                if(i === 7) {
                    colorStyle += `.level_value_L7 { background-color: #f006 }`;
                }
                if(i === 8) {
                    colorStyle += `.level_value_L8 { background-color: #f009 }`;
                }
            });
    ...
    function AllSumTable({
        ...
        return jsxs("div", {
            children: [jsxs("table", {
                ...
                children: [['EMITTER_A', 'R', '腳'], ['EMP_BURSTER', 'B', '砲'], ['ULTRA_STRIKE', 'US', '針'], ['POWER_CUBE', 'PC', 'PC']].map(([type, short, nickname]) => jsxs(Fragment, {
                    children: [jsxs("tr", {
                        children: [jsx("th", {
                            children: nickname
                        ...
                        children: [jsx("th", {
                            ...
                            className: i === 7 ? 'level_value_L7' : i === 8 ? 'level_value_L8' : 'level_value_default',
    ...
    function setupDisplay() {
        ...
        if (window.useAndroidPanes()) {
            android.addPane('playerInventory', '物資清單', 'ic_action_view_as_list');
